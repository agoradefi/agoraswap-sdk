...
export class Currency {
   ...
   */
  public static readonly METIS: Currency = new Currency(18, 'METIS', 'Metis Token')
...
const METIS = Currency.METIS
const DEFAULT_CURRENCIES = [ETHER, HARMONY, BINANCE_COIN, METIS]
